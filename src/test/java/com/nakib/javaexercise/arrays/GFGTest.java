...
class GFGTest {
    ...
    void findxinkindowSize_empty() {
        ...
        Assertions.assertFalse(GFG.findxinkindowSize(numberList, 2, 2));
    }

    @Test
    void findxinkindowSize_first() {
        int [] numberList = new int[] {2, 1};
        Assertions.assertTrue(GFG.findxinkindowSize(numberList, 2, 2));
    }

    @Test
    void findxinkindowSize_first_key_less_Size() {
        int [] numberList = new int[] {2, 1};
        Assertions.assertTrue(GFG.findxinkindowSize(numberList, 2, 3));
    }
    ...
    void findxinkindowSize_multiple_Batch_middle_batch_false()    {
        ...
        Assertions.assertFalse(GFG.findxinkindowSize(numberList, 2, 3));
    }
